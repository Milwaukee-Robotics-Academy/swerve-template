...
public class Swerve extends SubsystemBase {
    ...
    public Command followTrajectoryCommand(ArrayList<PathPlannerTrajectory> path, HashMap<String, Command> eventMap,
        ...
        SwerveAutoBuilder autoBuilder = new SwerveAutoBuilder(
                ...
                new PIDConstants(Constants.Swerve.DRIVE_KP, Constants.Swerve.DRIVE_KI, Constants.Swerve.DRIVE_KD), 
                new PIDConstants(Constants.Swerve.ANGLE_KP, Constants.Swerve.ANGLE_KI, Constants.Swerve.ANGLE_KD), 
