...
public class Constants {
  ...
  public static class Swerve {
    ...
    public static final double TRACK_WIDTH = Units.inchesToMeters(18.75); // TODO: Set width of the drivetrain measured from the middle of the wheels.
    public static final double WHEEL_BASE = Units.inchesToMeters(14.75); // TODO: Set length of the drivetrain measured from the middle of the wheels.
    ...
    public static final double DRIVE_GEAR_RATIO = 6.75 / 1.0; // TODO: set based on gearing of specific modules used. 6.75:1 for MK4i L2
    ...
    public static final SwerveModuleConstants MOD_0_Constants = new SwerveModuleConstants(
      ...
      2,
      3,
      Rotation2d.fromDegrees(203.115234),
      "Front Left"
    );
    ...
    public static final SwerveModuleConstants MOD_1_Constants = new SwerveModuleConstants(
      ...
      5,
      6,
      Rotation2d.fromDegrees(191.074219),
      "Front Right"  
    );
    ...
    public static final SwerveModuleConstants MOD_2_Constants = new SwerveModuleConstants(
      ...
      8,
      9,
      Rotation2d.fromDegrees(203.906250),
      "Rear Left"
    );
    ...
    public static final SwerveModuleConstants MOD_3_Constants = new SwerveModuleConstants(
      ...
      11,
      12,
      Rotation2d.fromDegrees(155.214844),
      "Rear Right"
    );
  }
